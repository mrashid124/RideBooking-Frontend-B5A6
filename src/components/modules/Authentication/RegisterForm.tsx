...
const registerSchema = z.object({
        name: z.string().min(3, { error: "Name must be at least 3 characters", }).max(50),
        email: z.email(),
        password: z.string().min(8, { error: "Password must be minimum 8 characters" }).regex(passwordRegex, {
